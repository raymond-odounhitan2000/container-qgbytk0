...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qgbytk0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qgbytk0.containers.anotherwebservice.com/
...
```
git clone git@github.com:raymond-odounhitan2000/container-qgbytk0.git
cd container-qgbytk0
```
...
```
docker attach container-qgbytk0
```
